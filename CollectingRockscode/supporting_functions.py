...
def update_rover(Rover, data):
    ...
    print('speed =', Rover.vel, 'position =', Rover.pos, 'throttle =',
          ...
          'samples collected:', Rover.samples_collected,'Rover_mode:', Rover.mode, 
          'Rover.way1',Rover.way1,'Rover.way2', Rover.way2,'Rover.counter', Rover.counter,
          'Rover.go_left',Rover.go_left)           
